...
{
    if ( character_struct_ptr -> level_struct_ptr != NULL ) free(character_struct_ptr -> level_struct_ptr); 
    if ( character_struct_ptr -> skillpoints_struct_ptr != NULL ) free(character_struct_ptr -> skillpoints_struct_ptr);
    //if ( character_struct_ptr -> backpack_struct != NULL ) free(character_struct_ptr -> backpack_struct);
    if ( character_struct_ptr -> character_map_position_struct_ptr != NULL ) free(character_struct_ptr -> character_map_position_struct_ptr);
    if ( character_struct_ptr != NULL ) free(character_struct_ptr);
}
